...
import { Users, ArrowRight, Search, Menu, X, Calendar, Trophy, Star, ImageIcon, Award } from "lucide-react"
...
export default function HomePage() {
  ...
  const latestUpdates = [
    {
      title: "New Technical Workshop Series Launched",
      date: "2 days ago",
      description: "Exciting new workshop series on AI/ML and Web Development starting next week.",
      type: "announcement",
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      >
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div
            className={`space-y-8 ${visibleElements.has("home") ? "animate-in slide-in-from-left duration-1000" : "opacity-0"}`}
          >
          ...
          <div
            className={`relative ${visibleElements.has("home") ? "animate-in slide-in-from-right duration-1000 delay-300" : "opacity-0"}`}
          >
      ...
      <section id="committees" ref={committeesRef} className="relative z-10 py-20 px-4" data-animate>
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 ${visibleElements.has("committees") ? "animate-in fade-in duration-1000" : "opacity-0"}`}
          >
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
              At Schologamma, our vibrant and dynamic community thrives through the dedication and collaborative efforts
              of various committees. Each committee plays a crucial role in shaping the forum's activities, events, and
              initiatives.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {committees.map((committee, index) => (
              <Card
                key={index}
                className={`bg-gradient-to-br ${committee.color} backdrop-blur-sm border-gray-700 hover:border-orange-500 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 ${committee.hoverColor} hover:shadow-2xl group ${
  ...
  />
          ...
          <div
            className={`text-center mt-16 ${visibleElements.has("committees") ? "animate-in slide-in-from-bottom duration-1000 delay-500" : "opacity-0"}`}
          >
      ...
      <section id="about" ref={aboutRef} className="relative z-10 py-20 px-4" data-animate>
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 ${visibleElements.has("about") ? "animate-in fade-in duration-1000" : "opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-orange-400 bg-clip-text text-transparent">
              About Schologamma
            </h2>
            <div className="max-w-4xl mx-auto space-y-6 text-lg text-gray-300 leading-relaxed">
              <p>
                Schologamma Forum is the premier student organization at JD College of Engineering & Management,
                dedicated to fostering innovation, technical excellence, and leadership among students. Our vibrant
                community brings together passionate individuals who are committed to learning, growing, and making a
                meaningful impact in the field of technology and beyond.
              </p>
              <p>
                Through our diverse range of committees and initiatives, we organize workshops, seminars, coding
                competitions, and technical events that provide students with hands-on experience and industry exposure.
                Our mission is to bridge the gap between academic learning and practical application, preparing students
      ...
      <section id="updates" ref={updatesRef} className="relative z-10 py-20 px-4 bg-gray-900/30" data-animate>
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 ${visibleElements.has("updates") ? "animate-in fade-in duration-1000" : "opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-orange-400 bg-clip-text text-transparent">
              Latest Updates
            </h2>
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Stay informed with the latest news, announcements, and opportunities from Schologamma Forum.
            </p>
          </div>
      ...
      <section id="events" ref={eventsRef} className="relative z-10 py-20 px-4" data-animate>
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 ${visibleElements.has("events") ? "animate-in fade-in duration-1000" : "opacity-0"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-orange-400 bg-clip-text text-transparent">
              Featured Events
            </h2>
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Discover our upcoming workshops, seminars, and competitions designed to enhance your skills and knowledge.
            </p>
          </div>
          ...
          <div
            className={`text-center mt-16 ${visibleElements.has("events") ? "animate-in slide-in-from-bottom duration-1000 delay-500" : "opacity-0"}`}
          >
            <Link href="/events">
              <Button
                size="lg"
      ...
      <section id="gallery" ref={galleryRef} className="relative z-10 py-12 px-4 bg-gray-900/20" data-animate>
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-12 ${visibleElements.has("gallery") ? "animate-in fade-in duration-1000" : "opacity-0"}`}
          >
            ...
            <p className="text-gray-400 text-base max-w-2xl mx-auto">Quick glimpse of our vibrant community moments.</p>
          </div>

          <div className="space-y-8">
            <div
              className={`flex items-center justify-center space-x-4 ${
                visibleElements.has("gallery") ? "animate-in slide-in-from-left duration-1000" : "opacity-0"
              }`}
            >
              <div className={`p-3 rounded-full bg-gradient-to-r ${galleryCategories[0].color} backdrop-blur-sm`}>
                {galleryCategories[0].icon}
              </div>
              <div className="text-center">
                <h3 className="text-xl font-bold text-white mb-2">{galleryCategories[0].title}</h3>
                <p className="text-gray-400 text-sm">{galleryCategories[0].description}</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {galleryCategories[0].images.map((image, imageIndex) => (
                <Card
                  key={imageIndex}
                  className={`bg-gradient-to-br ${galleryCategories[0].color} backdrop-blur-sm border-gray-700 hover:border-orange-500 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 hover:shadow-2xl group overflow-hidden ${
          ...
          <div
            className={`text-center mt-12 ${visibleElements.has("gallery") ? "animate-in slide-in-from-bottom duration-1000 delay-500" : "opacity-0"}`}
          >
            <Link href="/gallery">
              <Button
                size="lg"
